...
- تحويل أسعار Steam مباشرة إلى الريال السعودي.

- تحديث أسعار الصرف تلقائياً كل 24 ساعة.

- استخدام السعر الرسمي للدولار مقابل الريال (3.75).
...
2. استورد ملف **WDSteam-Tampermonkey**.
...
بمجرد زيارة أي صفحة في متجر Steam أو صفحات المجتمع التي تحتوي على أسعار بإحدى العملات المدعومة، ستظهر القيمة المقابلة بالريال السعودي أسفل السعر الأصلي تلقائياً.
...
- الوصول إلى `open.er-api.com` لجلب أسعار الصرف.
